...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#87ceeb' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#87ceeb',
  primary2: darkMode ? '#3680E7' : '#87ceeb',
  primary3: darkMode ? '#4D8FEA' : '#87ceeb',
  primary4: darkMode ? '#376bad70' : '#87ceeb',
  primary5: darkMode ? '#153d6f70' : '#87ceeb',

  // color text
  primaryText1: darkMode ? '#6da8ff' : '#87ceeb',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #87ceeb 0%, #fff 0%)`,
})
